              ...
              <ul class="list-unstyled ps-0">
                ...
                <li>
                  <a href="#">
                    ...
                    >
                      <path
                        d="M16 6.3125L6 11.3125L16 16.3125L26 11.3125L16 6.3125Z"
                        stroke="white"
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                      <path
                        d="M6 21.3125L16 26.3125L26 21.3125"
                        stroke="white"
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                      <path
                        d="M6 16.3125L16 21.3125L26 16.3125"
                        stroke="white"
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
              ...
              <ul class="list-unstyled ps-0 mb-0">
                ...
                <li>
                  <a href="#">
                    ...
                    >
                      <path
                        d="M27 10.3125L17.5 19.8125L12.5 14.8125L5 22.3125"
                        stroke="white"
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
              ...
              <div class="top-bar">
                ...
                <div class="top-bar-options">
                  <div class="create-job-links">
                    <a href="./create-new-job.html">+ Create New Job</a>
                  </div>
                  ...
                  <div class="profile-info">
                    <div class="dropdown">
                      ...
                      >
                        <img
                          src="./img/dashboard/profile-image.png"
                          alt="profile image"
                        />
                      </button>
                      <ul class="dropdown-menu">
                ...
                <div class="row no-gutters">
                  <div class="col-md-12">
                    <div class="applicants-bar">
                      ...
                      <a href="./all-applicants.html" class="text-decoration-none"
                        >See All
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="20"
                  ...
                  <div class="col-md-12">
                    <div class="all-tabs">
                      <div class="see-all-links">
                        <a href="./all-jobs.html" class="text-decoration-none"
                          >See All
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="20"
