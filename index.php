              ...
              <div class="row no-gutters">
                <div class="col-md-12">
                  <div class="applicants-bar">
                    ...
                    <a href="#" class="text-decoration-none">See All
                        ...
                        <div class="applicants-wrapper">
                            ...
                            <div class="card">
                              <div class="card-body">
                                <div class="applicants-image">
                                  <img src="./img/dashboard/applicants/applicants-1.png" alt="Applicants - 1"
                                    class="img-fluid" />
                                </div>
                                <div class="details">
                                  <h3>Jason Ruly</h3>
                          ...
                          <a href="#" class="text-decoration-none">
                            <div class="card">
                              <div class="card-body">
                                <div class="applicants-image">
                                  <img src="./img/dashboard/applicants/applicants-2.png" alt="Applicants - 2"
                                    class="img-fluid" />
                                </div>
                                <div class="details">
                                  <h3>Jason Ruly</h3>
                          ...
                          <a href="#" class="text-decoration-none">
                            <div class="card">
                              <div class="card-body">
                                <div class="applicants-image">
                                  <img src="./img/dashboard/applicants/applicants-3.png" alt="Applicants - 3"
                                    class="img-fluid" />
                                </div>
                                <div class="details">
                                  <h3>Jason Ruly</h3>
                          ...
                          <a href="#" class="text-decoration-none">
                            <div class="card">
                              <div class="card-body">
                                <div class="applicants-image">
                                  <img src="./img/dashboard/applicants/applicants-4.png" alt="Applicants - 4"
                                    class="img-fluid" />
                                </div>
                                <div class="details">
                                  <h3>Jason Ruly</h3>
                          ...
                          <a href="#" class="text-decoration-none">
                            <div class="card">
                              <div class="card-body">
                                <div class="applicants-image">
                                  <img src="./img/dashboard/applicants/applicants-5.png" alt="Applicants - 5"
                                    class="img-fluid" />
                                </div>
                                <div class="details">
                                  <h3>Jason Ruly</h3>
                    ...
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                      ...
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="recruitment-plan-tab" data-bs-toggle="pill"
                          data-bs-target="#recruitment-plan" type="button" role="tab" aria-controls="recruitment-plan"
                          aria-selected="false">
                          Recruitment Plan
                        </button>
                      </li>
                                      ...
                                      <a class="modal-pointer" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                          ...
                                          <path
                                            ...
                                            stroke="#667085" stroke-width="1.67" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                          <path d="M7.16016 11.2578L12.8518 14.5745" stroke="#667085"
                                            stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round" />
                                          <path d="M12.8435 5.42578L7.16016 8.74245" stroke="#667085"
                                            stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                      </a>
                                    </li>
              ...
              <div class="row no-gutters">
                ...
                <div class="col-lg-6 col-xl-4 px-2">
                  <div class="card">
                    ...
                    <p>
                      Lorem ipsum dolor sit amet consectetur. Viverra aliquet dolor eu mauris leo tempus orci augue sed.
                      Sed tortor Lorem ipsum dolor sit amet consectetur. Viverra aliquet dolor eu mauris leo tempus orci
