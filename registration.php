              ...
              <div class="card-body p-0 h-100 ">
                ...
                <form method="post" action="/form" autocomplete="off">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="companyName" autocomplete="off" required>
                  </div>
                  <div class="form-group">
                    <label class="form-label" for="industryType">Industry Type</label>
                    <select id="industryType" class="form-select" aria-label="Default select example" required>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-select" id="numberOfEmployees" aria-label="Default select example" required>
                      <option selected>Select</option>
                  ...
                  <div class="form-group custom-select2">
                    ...
                    <select class="form-select" required aria-label="Default select example" id="countries">
                  ...
                  <div class="form-group">
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="exampleCheck1">I Agree With The <a href="#">Terms & Conditions</a> Of smartemployeerz.com</label>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="d-grid col-12">
                      <button type="submit" class="btn text-white rounded-0 ">Create Account</button>
                    </div>
                  </div>
                </form>
