                ...
                <div class="card-body p-0 h-100">
                  <form method="get" id="regForm" autocomplete="off">
                    ...
                    <div class="tab">
                      ...
                      <div class="form-group">
                        <label class="form-label" for="mobile_code"
                          >Phone Number</label
                        >
                        <input
                          oninput="this.className = ''"
                    ...
                    <div class="tab">
                      ...
                      <div class="form-group">
                        <label class="form-label" for="industryType"
                          >Industry Type</label
                        >
                        <select
                          id="industryType"
                      ...
                      <div class="form-group">
                        <label class="form-label" for="numberOfEmployees"
